...
public class Calculadora {
	...
	protected void createContents() {
		...
		txtHola = new Text(shell, SWT.BORDER);
		txtHola.setText("Hola");
		txtHola.setBounds(22, 19, 196, 21);
	...
	public int getResultatInt() {
		String resultat = txtHola.getText();
	...
	/**
	 * mostraResultat Actualitza la propietat text del quadre de text resutlats de
	 * la GUI per a mostrar el resultat del calcul
	 * 
	 * @param resultat resultat num�ric a mostrar
	 */
